...
class MultiApprovalType(models.Model):
    ...
    approve_python_code = fields.Text('Approved Action', default='record.button_approve()')
    refuse_python_code = fields.Text('Refused Action', default='record.button_cancel()')
